    ...
    return (
        <div className="w-full h-full flex flex-col justify-between min-h-[160px]">
            <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-[10px] text-neutral-400">{totalContributions} contributions (Last 4 Months)</span>
            </div>

            <div className="flex flex-col items-center w-full">
                {/* Month Labels */}
                <div className="flex gap-[4px] mb-2 w-full px-4 pb-1">
                    {Array.from({ length: weeks }).map((_, weekIndex) => {
                        ...
                        return (
                            <div key={weekIndex} className="w-2.5 sm:w-3 relative h-6 text-center">
                                {showLabel && (
                                    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 flex flex-col items-center">
                                        <span className="text-[10px] text-neutral-500 font-medium leading-none mb-1 tracking-tighter">
                                            {currentMonth}
                                        </span>
                                        <ChevronDown className="w-2.5 h-2.5 text-neutral-600/80" />
                                    </div>
                                )}
                            </div>
                        )
        ...
        <div className="flex flex-col justify-between h-full">
            ...
            <div className="space-y-2">
                <div className="flex items-baseline gap-2">
                    <h4 className="text-4xl font-display font-bold">{totalSolved}</h4>
