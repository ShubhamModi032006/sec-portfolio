        ...
        >
            ...
            <div style={{ transform: "translateZ(50px)" }} className="relative z-10 h-full p-8 flex flex-col justify-between pointer-events-none">
                ...
                <div className="translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                    <h3 className="text-4xl md:text-5xl font-display font-bold uppercase mb-4 text-white">{project.title}</h3>
                    ...
                    <div className="flex flex-wrap gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-200">
                        {project.technologies.map((tech, i) => (
                            <span key={i} className="text-xs uppercase tracking-wider text-neon-main font-bold">
                                #{tech}
                            </span>
                        ))}
                    </div>
